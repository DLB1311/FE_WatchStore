    ...
    <footer id="footer" >
      ...
      <div class="footer__content">
        <div class="footer__logo">
          <img src={urlImg + "dlb-logo.png"}  class="lazyloaded footer__logo_img" alt="logo"/>
        </div>
        <ul class="footer__main_nav">

          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" data-drupal-link-system-path="node/20">CONTACT US</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" target="_self" data-drupal-link-system-path="node/22"></a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" rel="noopener" target="_blank">PHONE</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" target="_self" data-drupal-link-system-path="node/21">0832131101</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" target="_self" data-drupal-link-system-path="node/25">0832131102</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link"></a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" target="_self" data-drupal-link-system-path="node/23">ADDRESS</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" data-drupal-link-system-path="node/3138">686 CMT8 STREET</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" data-drupal-link-system-path="node/3143">TAN BINH DISTRICT</a>
          </li>
          <li class="footer__main_item js_footer_item">
            <a href="" class="footer__link footer__animation_link" data-drupal-link-system-path="node/2908">HO CHI MINH CITY</a>
          </li>
